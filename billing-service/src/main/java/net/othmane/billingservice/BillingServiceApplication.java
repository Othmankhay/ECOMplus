package net.othmane.billingservice;
...
import net.othmane.billingservice.model.Customer;
import net.othmane.billingservice.model.Product;
import net.othmane.billingservice.repository.BillRepository;
import net.othmane.billingservice.repository.ProductItemRepository;
